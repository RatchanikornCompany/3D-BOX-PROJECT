...
const init = () => {
  ...
  lid_shape.lineTo(0, C - 22);
  lid_shape.lineTo(A, C - 22);
  ...
  lr_lid_shape.lineTo(0, C - 27);
  lr_lid_shape.lineTo(A - 155, C - 27);
  lr_lid_shape.lineTo(A - 155, C - 39);
  lr_lid_shape.lineTo(A - 150, C - 39);
  lr_lid_shape.lineTo(A - 135, C - 23);
  lr_lid_shape.lineTo(A - 40, C - 23);
  lr_lid_shape.lineTo(A - 25, C - 39);
  lr_lid_shape.lineTo(A - 20, C - 39);
  lr_lid_shape.lineTo(A - 20, C - 27);
  lr_lid_shape.lineTo(A, C - 27);
  lr_lid_shape.lineTo(A, 0);
  lr_lid_shape.lineTo(A - 35, 0);
  lr_lid_shape.lineTo(A - 35, C - 55);
  lr_lid_shape.lineTo(A - 140, C - 55);
  lr_lid_shape.lineTo(A - 140, 0);
  ...
  lid_Bottom_shape.lineTo(A - 170, C - 22.5);
  lid_Bottom_shape.lineTo(A - 42, C - 22.5);
  ...
  lr_lid_Bottom_shape.moveTo(0, C - 35);
  lr_lid_Bottom_shape.lineTo(0, C - 35);
  lr_lid_Bottom_shape.lineTo(A - 161, C - 17);
  lr_lid_Bottom_shape.lineTo(A - 139, C - 17);
  lr_lid_Bottom_shape.lineTo(A - 139, C - 67);
  lr_lid_Bottom_shape.lineTo(A - 143, 0);
  ...
  lr_lid_Bottom_shape_d.lineTo(A - 173.3, C - 56.5);
  lr_lid_Bottom_shape_d.lineTo(A - 104, C - 56.5);
  lr_lid_Bottom_shape_d.bezierCurveTo(
    A - 98,
    C - 63,
    A - 93,
    C - 66.5,
  ...
  lid_curve_shape.lineTo(B - 75, C - 27);
  lid_curve_shape.bezierCurveTo(B - 75, C - 27, B - 53, C - 10, B - 30, C - 27);
  lid_curve_shape.lineTo(B - 121, C - 27);
  lid_curve_shape.lineTo(B, 0);
  lid_curve_shape.lineTo(B - 52, 0);
  lid_curve_shape.lineTo(B - 52, C - 27);
  lid_curve_shape.lineTo(B - 55, C - 27);
  lid_curve_shape.lineTo(B - 55, 0);
  ...
  lid_bottom_curve_shape.lineTo(B - 78, C - 33);
  lid_bottom_curve_shape.lineTo(B - 53, C - 33);
  ...
  side_B_left_edges.position.set(-B / 2, C / 2);
  ...
  side_A_back_edges.position.set(-A / 2, C / 2);
  ...
  pivot_Bottom_front_lid.position.x = A - 42;
  pivot_Bottom_front_lid.position.y = -(C - 62.5);

  pivot_Bottom_front_lid_d = new THREE.Object3D();
  pivot_Bottom_front_lid_d.add(side_lid_d_Bottom_A_front);
  pivot_Bottom_front_lid_d.position.set(A - 170, -(C - 22.5));
  ...
  pivot_Top_back_lid.position.y = C - 23;
  ...
  pivot_Bottom_back_lid.position.x = -A + 133;
  pivot_Bottom_back_lid.position.y = -(C - 62.5);

  pivot_Bottom_back_lid_d = new THREE.Object3D();
  pivot_Bottom_back_lid_d.add(side_lid_d_Bottom_A_back);
  pivot_Bottom_back_lid_d.position.set(-(A - 5), -(C - 22.5));
  ...
  pivot_Top_front_lid.position.y = C - 23;
  ...
  pivot_Bottom_front_lid_edges.position.x = A - 42;
  pivot_Bottom_front_lid_edges.position.y = -(C - 62.5);

  pivot_Bottom_front_lid_d_edges = new THREE.Object3D();
  pivot_Bottom_front_lid_d_edges.add(side_lid_d_Bottom_A_front_edges);
  pivot_Bottom_front_lid_d_edges.position.set(A - 170, -(C - 22.5));
  ...
  pivot_Top_back_lid_edges.position.y = C - 23;
  ...
  pivot_Bottom_back_lid_edges.position.x = -A + 133;
  pivot_Bottom_back_lid_edges.position.y = -(C - 62.5);

  pivot_Bottom_back_lid_d_edges = new THREE.Object3D();
  pivot_Bottom_back_lid_d_edges.add(side_lid_d_Bottom_A_back_edges);
  pivot_Bottom_back_lid_d_edges.position.set(-(A - 5), -(C - 22.5));
  ...
  pivot_Top_front_lid_edges.position.y = C - 23;
