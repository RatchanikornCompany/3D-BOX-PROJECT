...
const rotations1 = () => {
  ...
  tween.to(pivot_Right_edges.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivot_Right_edges.y = Math.PI / 2), // 120
  });
  ...
  tween.to(pivot_A_bottom_front_right_edges.rotation, {
    ...
    z: (pivot_A_bottom_front_right_edges.z = Math.PI / 2),
  });
  ...
  tween.to(pivot_A_bottom_back_right_edges.rotation, {
    ...
    z: (pivot_A_bottom_back_right_edges.z = Math.PI / 2),
  });
  /* #endregion */
  /* #region  pivot_Glue_lid_edges */
...
const init = () => {
  ...
  plane_B_Bottom_lid_shape.lineTo(0, (C * 0.248) | 0);
  plane_B_Bottom_lid_shape.lineTo((B * 0.5) | 0, (C * 0.248) | 0);
  ...
  glue_Lid_shape.lineTo((P * 3) | 0, (C * 0.824) | 0);
  ...
  side_A_back_d.rotation.y = Math.PI;
  ...
  side_Glue_Lid_d.rotation.set(Math.PI, Math.PI, 0);

  side_Glue_center = new THREE.Mesh(glue_Center, material);
  side_Glue_center.rotation.set(Math.PI, Math.PI, 0);

  side_Glue_Center_lid = new THREE.Mesh(glue_Center_lid, material);
  side_Glue_Center_lid.rotation.set(Math.PI, Math.PI, 0);
  ...
  pivot_A_bottom_front.position.y = (C * 0.177) | 0;
  ...
  pivot_A_bottom_back.position.y = (C * 0.177) | 0;
  ...
  pivot_Left_bottom_lid_left.position.y = -(C * 0.177) | 0;
  ...
  pivot_Right_bottom_lid_right.position.y = -(C * 0.177) | 0;
  ...
  pivot_Right_bottom_lid_left.position.y = -(C * 0.177) | 0;
  ...
  side_A_back_d_edges.rotation.y = Math.PI;
  ...
  side_B_left_bottom_lid_right_edges.rotation.x = Math.PI;
  ...
  side_B_left_bottom_left_edges.rotation.x = Math.PI;
  ...
  side_B_left_bottom_d_left_edges.rotation.x = Math.PI;
  ...
  side_B_left_bottom_lid_left_edges.rotation.set(Math.PI, Math.PI, 0);
  ...
  side_B_right_bottom_lid_left_edges.rotation.z = Math.PI;
  ...
  side_B_right_bottom_right_edges.rotation.set(Math.PI, Math.PI, 0);
  ...
  side_B_right_bottom_d_right_edges.rotation.set(Math.PI, Math.PI, 0);
  ...
  side_B_right_bottom_lid_right_edges.rotation.x = Math.PI;
  ...
  side_Glue_center_edges.rotation.set(Math.PI, Math.PI, 0);
  ...
  side_Glue_Center_lid_edges.rotation.set(Math.PI, Math.PI, 0);
  ...
  pivot_A_bottom_front_right_edges.position.x = A;
  ...
  pivot_Glue_Lid_d_edges.position.y = -(C * 0.089) | 0;
  ...
  pivot_A_bottom_back_left_edges.position.x = -A;
  ...
  pivot_A_bottom_back_edges.position.y = (C * 0.177) | 0;
  ...
  pivot_Back_edges.position.x = -B / 2;
  ...
  pivot_Left_bottom_lid_left_edges.position.y = -(C * 0.177) | 0;
  ...
  pivot_Left_bottom_left_edges.position.x = -B / 2;
  ...
  pivot_Left_l_edges.position.x = -B / 2;
  ...
  pivot_Right_bottom_lid_right_edges.position.y = -(C * 0.177) | 0;
  ...
  pivot_Right_bottom_right_edges.position.x = B / 2;

  pivot_Right_r_edges = new THREE.Object3D();
  pivot_Right_r_edges.add(side_B_right_r_edges, pivot_Right_bottom_right_edges);
  pivot_Right_r_edges.position.x = B / 2;
  ...
  pivot_Right_bottom_lid_left_edges.position.y = -(C * 0.177) | 0;
