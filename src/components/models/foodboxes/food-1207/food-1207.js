...
const init = (a, b, c, o) => {
  ...
  /* #region  //* a_Front */
  side_A_front_top = new THREE.Mesh(plane_A, material(O));
  ...
  /* #region  //* b_Left */
  side_B_front_left = new THREE.Mesh(plane_B, material(O));
  side_B_front_left.rotation.y = (Math.PI / 180) * 180;

  side_B_left_lid = new THREE.Mesh(lr_Lid, material(O));
  ...
  side_B_left_lid_d = new THREE.Mesh(lr_Lid_d, material(O));
  ...
  /* #region  //* b_Right */
  side_B_front_right = new THREE.Mesh(plane_B, material(O));

  side_B_right_lid = new THREE.Mesh(lr_Lid, material(O));

  side_B_right = new THREE.Mesh(plane_B_side, material(O));
  side_B_right.position.set(C / 2, B / 2, 0);

  side_B_right_lid_d = new THREE.Mesh(lr_Lid_d, material(O));
  side_B_right_lid_d.rotation.set((Math.PI / 180) * 180, 0, 0);
  /* #endregion */

  /* #region  //* a_Back */
  side_A_top = new THREE.Mesh(plane_A_top, material(O));

  side_A_back = new THREE.Mesh(plane_A_side, material(O));
  side_A_back.position.set(A / 2, B / 2, 0);

  side_Lid_bottom = new THREE.Mesh(lid_Bottom, material(O));
  side_Lid_bottom.rotation.x = (Math.PI / 180) * 180;

  side_Lid_bottom_d = new THREE.Mesh(lid_Bottom_d, material(O));
  side_Lid_bottom_d.position.y = -C;

  side_lr_lid_Bottom_left = new THREE.Mesh(lr_lid_Bottom, material(O));
  side_lr_lid_Bottom_left.rotation.x = (Math.PI / 180) * 180;

  side_lr_lid_Bottom_right = new THREE.Mesh(lr_lid_Bottom, material(O));
  ...
  pivot_All_edges.add(pivot_A_back_edges, pivot_All);
