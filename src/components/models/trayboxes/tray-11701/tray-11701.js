...
const init = (a, b, c, o) => {
  ...
  /* #endregion */
  /* #region  //* side_B_left */
  side_lid_B_left = new THREE.Mesh(lid_B_left_right, material(O));
  ...
  /* #endregion */
  /* #region  //* side_B_right */
  side_lid_B_right = new THREE.Mesh(lid_B_left_right, material(O));
  ...
  side_dust_flap_lid_A_left = new THREE.Mesh(dust_flap_lid, material(O));
  side_dust_flap_lid_A_left.rotation.set(0, (Math.PI / 180) * 180, 0);

  side_dust_flap_lid_A_right = new THREE.Mesh(dust_flap_lid, material(O));

  side_lr_lid_A_top = new THREE.Mesh(plane_C_side, material(O));
  side_lr_lid_A_top.position.x = A / 2;
  side_lr_lid_A_top.position.y = C / 2;
  /* #endregion */
  /* #region  //* side_lid_A_top */
  side_lr_lid_A_top_left = new THREE.Mesh(lr_lid_A_left_right, material(O));
  side_lr_lid_A_top_left.rotation.set(0, 0, (Math.PI / 180) * 90);

  side_lr_lid_A_top_right = new THREE.Mesh(lr_lid_A_left_right, material(O));
  ...
  side_lid_A_top = new THREE.Mesh(plane_A_side, material(O));
  side_lid_A_top.position.x = A / 2;
  side_lid_A_top.position.y = B / 2;
  /* #endregion */
  /* #region  //* side_A_top */
  side_dust_flap_Top_left = new THREE.Mesh(dust_flap, material(O));
  side_dust_flap_Top_left.rotation.set(0, (Math.PI / 180) * 180, 0);

  side_dust_flap_Top_right = new THREE.Mesh(dust_flap, material(O));

  side_A_top = new THREE.Mesh(plane_C_side, material(O));
  side_A_top.position.set(A / 2, C / 2, 0);
  /* #endregion */
  /* #region  //* side_A_bottom */
  side_dust_flap_Bottom_left = new THREE.Mesh(dust_flap, material(O));
  ...
  side_dust_flap_Bottom_right = new THREE.Mesh(dust_flap, material(O));
  side_dust_flap_Bottom_right.rotation.set((Math.PI / 180) * 180, 0, 0);

  side_A_bottom = new THREE.Mesh(plane_C_side, material(O));
