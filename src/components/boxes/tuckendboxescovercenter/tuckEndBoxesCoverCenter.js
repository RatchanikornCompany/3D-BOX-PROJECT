...
export const tuckEndBoxesCover = (A, B, C, F, P, G, GSlope, unit) => {
  let L = ((B / 100) * 85) | 0,
    p_slope = 5;
  ...
  lineMarkP.position.set(A / 2 + G + A + B, B + P + C, 2); //ตำแหน่ง pic P
  lineMarkP.add(meshP);
  ...
  lableB3.position.set(G + A + B + A / 2, B / 2 + C, 2);
  ...
  lableD.position.set(-G + -10, C / 2, 2);
