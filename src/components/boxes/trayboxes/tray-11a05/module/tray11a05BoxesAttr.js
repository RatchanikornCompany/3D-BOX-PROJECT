...
export const tray11A05Model = (A, B, C, O, animate, materialColor) => {
  ...
  sideLRLidABottomLeft.castShadow = true;
  ...
  sideLRLidABottomRight.castShadow = true;
