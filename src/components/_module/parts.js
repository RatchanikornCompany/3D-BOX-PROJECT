...
export default class PARTS {
  ...
  cover3() {
    ...
    this.red_group2.push(
      new THREE.Vector2(this.width / 2 - 10, this.depth + 5)
    );
    this.red_group2.push(
  ...
  flap1() {
    ...
    this.red_line.push(
      new THREE.Vector2(2, (this.width / 100) * this.flap - 2)
    );
    this.red_line.push(
  ...
  flap2() {
    ...
    this.red_line.push(new THREE.Vector2(0, 0));
    this.red_line.push(
      new THREE.Vector2(0, (this.width / 100) * this.flap - 2)
    );
    this.red_line.push(
      new THREE.Vector2(this.depth - 8, (this.width / 100) * this.flap - 2)
    );
  ...
  flap4() {
    ...
    this.red_line.lineTo(
      0,
      ((((this.width / 100) * this.flap) / 100) * 15) | 0
    ); //0,4
  ...
  flap5() {
    ...
    this.red_line.lineTo(
      0,
      ((((this.width / 100) * this.flap) / 100) * 20) | 0
    );
    this.red_line.lineTo(
      ((this.depth / 100) * 6) | 0,
  ...
  handle_lock() {
    ...
    //! Red_lines_g2.
    this.red_line_g2.moveTo(
      this.longhand_fix + 3,
      ((this.plug / 100) * 65) | 0
    );
    this.red_line_g2.lineTo(
      this.longhand_fix + 5,
      ((this.flap / 100) * 94) | 0
    );
  ...
  lockOnBox() {
    ...
    this.circle.position.y =
      this.lockHeight + this.depthSpace + this.radius / 2;
  ...
  lockOnBoxCream() {
    ...
    this.green_line.push(
      new THREE.Vector2(0, this.lockHeight_Fix + this.depth)
    );
    ...
    this.green_line.push(
      new THREE.Vector2(this.width - 1, this.lockHeight_Fix)
    );
  ...
  flapSnaplock() {
    ...
    this.red_line.push(new THREE.Vector2(0, 0));
    this.red_line.push(
      new THREE.Vector2(0, (this.depth / 100) * this.flap - 2)
    );
    this.red_line.push(
  ...
  flap22() {
    ...
    this.red_line.lineTo(3, this.height / 2 - 10);
    ...
    this.red_line.lineTo(this.height - 15, this.height / 2 - 5);
  ...
  flap222() {
    ...
    this.green_line.push(new THREE.Vector2(0, 0));
    this.green_line.push(new THREE.Vector2(this.depth / 2, this.height));
    ...
    this.scene.add(this.red_lines, this.green_lines_g1);
