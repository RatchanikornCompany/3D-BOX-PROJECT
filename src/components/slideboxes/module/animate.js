...
export const foldBox = (
  ...
  tween.to(pivotDustFlapLeftTop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotDustFlapLeftTop.x = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotDustFlapLeftBottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotDustFlapLeftBottom.x = (Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotInnerFlapLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivotInnerFlapLeft.y = (Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotDustFlapRightTop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotDustFlapRightTop.x = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotDustFlapRightBottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotDustFlapRightBottom.x = (Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotInnerFlapRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivotInnerFlapRight.y = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotLidATop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotLidATop.x = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(pivotDustFlapTopLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivotDustFlapTopLeft.y = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(pivotDustFlapTopRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivotDustFlapTopRight.y = (Math.PI / 180) * 180),
  });
  ...
  tween.to(pivotInnerFlapTop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotInnerFlapTop.x = (Math.PI / 180) * 90),
  });
  ...
  tween.to(pivotLidABottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotLidABottom.x = (Math.PI / 180) * 180),
  });
  ...
  tween.to(pivotDustFlapBottomLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivotDustFlapBottomLeft.y = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(pivotDustFlapBottomRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (pivotDustFlapBottomRight.y = (Math.PI / 180) * 180),
  });
  ...
  tween.to(pivotInnerFlapBottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (pivotInnerFlapBottom.x = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotLidBLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotLidBLeft.y = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotDustFlapLeftTop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotDustFlapLeftTop.x = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotDustFlapLeftBottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotDustFlapLeftBottom.x = (Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotInnerFlapLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotInnerFlapLeft.y = (Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotLidBRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotLidBRight.y = (Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotDustFlapRightTop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotDustFlapRightTop.x = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotDustFlapRightBottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotDustFlapRightBottom.x = (Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotInnerFlapRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotInnerFlapRight.y = -(Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotLidATop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotLidATop.x = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotDustFlapTopLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotDustFlapTopLeft.y = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotDustFlapTopRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotDustFlapTopRight.y = (Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotInnerFlapTop.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotInnerFlapTop.x = (Math.PI / 180) * 90),
  });
  ...
  tween.to(getPivotLidABottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotLidABottom.x = (Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotDustFlapBottomLeft.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotDustFlapBottomLeft.y = -(Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotDustFlapBottomRight.rotation, {
    duration: 5,
    ease: 'power4.in',
    y: (getPivotDustFlapBottomRight.y = (Math.PI / 180) * 180),
  });
  ...
  tween.to(getPivotInnerFlapBottom.rotation, {
    duration: 5,
    ease: 'power4.in',
    x: (getPivotInnerFlapBottom.x = -(Math.PI / 180) * 90),
  });
};
