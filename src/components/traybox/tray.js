...
const init = () => {
  ...
  /* #endregion */
  /* #region  เซ็ทตำแหน่งของสีแต่ล่ะด้าน */
...
const rotations1 = () => {
  ...
  /* #endregion */
  /* #region  pivot_lr_Lid_A_bottom_left_edges */
  tween = gsap.timeline();
  ...
  /* #endregion */
  /* #region  pivot_lr_lid_A_bottom_right_edges */
  tween = gsap.timeline();
