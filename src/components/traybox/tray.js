...
const init = () => {
  ...
  /* #region  side_A_front */
  var side_A_front_x = new THREE.Mesh(plane_A_side, material);
  side_A_front_x.position.x = A / 2;
  side_A_front_x.position.y = B / 2;
  /* #endregion */
  /* #region  side_Glub_flap */
  var side_Glue_flap = new THREE.Mesh(glue_flap, material);
  side_Glue_flap.rotation.x = Math.PI;
  /* #endregion */
  /* #region  side_A_back */
  var side_A_back_x = new THREE.Mesh(plane_A_side, material);
  side_A_back_x.position.x = A / 2;
  side_A_back_x.position.y = B / 2;
  /* #endregion */
  /* #region  side_B_top_lid */
  var side_B_top_lid = new THREE.Mesh(plane_C_side, material);
  side_B_top_lid.position.x = A / 2;
  side_B_top_lid.position.y = C / 2;
  /* #endregion */
  /* #region  side_B_bottom_lid */
  var side_B_bottom_lid = new THREE.Mesh(plane_C_side, material);
  ...
  /* #region  pivot_Top */
  var pivot_Top_x = new THREE.Object3D();
  ...
  var pivot_B_bottom_lid = new THREE.Object3D();
  pivot_B_bottom_lid.add(side_B_bottom_lid, pivot_Front_x);
  pivot_B_bottom_lid.rotation.x = -Math.PI / 2;
  /* #endregion */
